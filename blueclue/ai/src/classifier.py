    ...
    def __init__(self, use_spacy=True):
        ...
        self.category_keywords = {
            "hardware": {
                ...
                "shutting down": (3.5, "power"),
                "keeps shutting down": (4.5, "power"),
                "shuts down unexpectedly": (4.5, "power"),
                "shut down unexpectedly": (4.5, "power"),
                "turns off": (3.0, "power"),
            ...
            "network": {
                ...
                # Campus / institutional WiFi — prevent auth vocabulary (credentials,
                # authenticate) from pulling these tickets to the login category.
                "campus wi-fi": (9.0, "wireless"),
                "campus wifi": (9.0, "wireless"),
                "connect to campus": (8.0, "wireless"),
                "wi-fi network": (5.0, "wireless"),
                "wifi network": (5.0, "wireless"),
                "secure network": (5.0, "wireless"),
                "network authentication": (8.0, "wireless"),
                "wifi authentication": (9.0, "wireless"),
                "wi-fi authentication": (9.0, "wireless"),
                ...
                "unable to connect": (4.5, "connectivity"),
                "failed to connect": (4.5, "connectivity"),
                "failing to connect": (4.0, "connectivity"),
        ...
        self.category_phrases = {
            "hardware": [
                ...
                "keeps shutting down", "shutting down", "shuts completely off",
            ],
            "software": [
            ...
            "network": [
                ...
                "campus wi-fi", "campus wifi", "connect to campus",
