...
-- Note: ticket_templates is NOT truncated - templates are seeded by migrations
TRUNCATE TABLE ticket_comments, ticket_history, ticket_assignments, ai_classifications, tickets RESTART IDENTITY CASCADE;
...
-- ============================================================================
-- TICKET TEMPLATES NOTE
-- ============================================================================
-- Ticket templates are created by migrations (019_add_ticket_templates.sql and 020_update_existing_templates.sql)
-- DO NOT add template INSERT statements here as they will overwrite migration-seeded data
