      ...
      <div className="bg-gray-900 rounded-lg border border-gray-700 shadow-sm">
        ...
        {loading && (
          <div className="flex justify-center items-center py-12">
            <LoadingSpinner message="Loading your assigned tickets..." />
          </div>
        )}
        ...
        {!loading && tickets.length === 0 && (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-400 text-lg">No tickets assigned to you</p>
            <p className="text-gray-500 text-sm mt-2">You have no currently assigned tickets!</p>
          </div>
        )}
